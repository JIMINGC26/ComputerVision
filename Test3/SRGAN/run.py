...
if __name__ == '__main__':
    ...
    parse.add_argument("--save_path", default=r"exp/exp_99.pth", type=str)
    parse.add_argument("--result_path", default=r"result/SRGAN_RESULT.png", type=str)
    parse.add_argument("--img_path", default=r"dataset/Set5/baby.png", type=str)
    parse.add_argument("--bicubic_path", default=r"result/bicubic._result.jpg", type=str)
