...
class Trainer:
    ...
    def __init__(self, args):
        ...
        self.gnet = model.Generator()
        self.dnet = model.Discriminator()
        batch = self.args.batch
        self.train_loader = DataLoader(dataset=SRGANDataset(self.args.train_path, zoom_factor=2, ty="train"),
                                       batch_size=batch, shuffle=True, drop_last=True)
        self.val_loader = DataLoader(dataset=SRGANDataset(self.args.val_path, zoom_factor=2, ty="val"),
                                     batch_size=batch, shuffle=True, drop_last=True)
        ...
        if self.args.resume:
            if not os.path.exists(self.args.save_path):
                ...
                print("Loaded params from {}\n[Epoch]: {}   [lr]: {}    [best_psnr]: {}".format(self.args.save_path,
                                                                                                self.epoch, self.lr,
                                                                                                self.best_psnr))
        self.gnet.to(device=self.device)
    ...
    def train(self, epoch):
        ...
        for i, (img, label) in enumerate(self.train_loader):
            ...
            # print(fake_img.shape, label.shape)
        ...
        torch.save(param_dict, f"{self.args.save_path}/exp_{epoch}.pth")
    ...
    def val(self, epoch):
        ...
        with torch.no_grad():
            ...
            if mpsnr > self.best_psnr:
                ...
                torch.save(param_dict, f"exp/exp_{epoch}.pth")
...
def main(args):
    ...
    for epoch in range(t.epoch, t.epoch + args.num_epochs):
        ...
        print("train_loss_d: ",train_loss_d, "train_loss_g: ", train_loss_g, "train_psnr: ", train_psnr, "\n")
        print("val_loss: ",val_loss, "val_psnr: ", val_psnr)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_path", default="dataset/T91", type=str)
    parser.add_argument("--val_path", default="dataset/Set5", type=str)
